...
> Instructions for the evaluation sub-agent spawned during the EVALUATE phase.
> The scaffold outputs the path to this file so the architect can provide it to the sub-agent.
...
2. **The plan format**: `.workspace/implementation_planning/planctl/PLAN_FORMAT.md`
